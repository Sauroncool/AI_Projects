...
def travel_speed(slat, slon, elat, elon):
    start_latitude = slat
    end_latitude = elat
...
start_latitude = 8.6255344
start_longitude = 77.0446066  # Near IIST library location

end_latitude = 8.51165
end_longitude = 76.96699

print(travel_speed(start_latitude, start_longitude, end_latitude, end_longitude))
